  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-amber-50 via-orange-50 to-yellow-50">
      ...
      <header className="sticky top-0 z-40 bg-white/80 backdrop-blur-md border-b border-amber-100 shadow-sm">
        <div className="max-w-4xl mx-auto px-4 py-3 flex items-center justify-between">
          <Link href="/dashboard" className="flex items-center gap-2">
            <Image src="/sally-logo.png" alt="Sally" width={36} height={36} className="rounded-full" />
            <span className="font-bold text-gray-800 hidden sm:block">Sally</span>
          </Link>
      ...
      <footer className="text-center text-xs text-gray-400 py-6">
        Sally · Strumento personale, non medico · WSAVA/AAHA/AAFP/ESCCAP
      </footer>
    </div>
  );
}
